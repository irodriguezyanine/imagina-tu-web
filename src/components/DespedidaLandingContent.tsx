...
export function DespedidaLandingContent({ modalFeature, setModalFeature, children }: Props) {
  return (
    <div role="main" className="min-h-screen bg-slate-950">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-90 bg-[length:60px_60px] bg-[image:url('data:image/svg+xml;charset=utf-8,%3Csvg%20width%3D%2260%22%20height%3D%2260%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Ccircle%20cx%3D%222%22%20cy%3D%222%22%20r%3D%220.8%22%20fill%3D%22%23fff%22%20fill-opacity%3D%220.04%22%2F%3E%3C%2Fsvg%3E')]" />
